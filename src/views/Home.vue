        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda la ejecución de proyectos como fase clave para alcanzar objetivos, aplicando enfoques como PMBOK, PRINCE2 y metodologías ágiles. Se analiza la gestión eficiente de recursos humanos, financieros y tecnológicos, así como el liderazgo y la adaptación al cambio organizacional. También se enfatiza la importancia de una comunicación efectiva y la gestión de stakeholders. Se integran teorías del cambio y estilos de liderazgo, subrayando la necesidad de estrategias participativas, monitoreo continuo y cultura colaborativa para lograr una transformación organizacional sostenible y proyectos exitosos.
